...
asignacion:
    ...
    | IDENTIFICADOR OP_SUMA OP_ASIGNACION expresion
    | IDENTIFICADOR OP_RESTA OP_ASIGNACION expresion
    | IDENTIFICADOR OP_DIVISION OP_ASIGNACION expresion
    | IDENTIFICADOR OP_MODULO OP_ASIGNACION expresion
    | IDENTIFICADOR OP_AND OP_ASIGNACION expresion
    | IDENTIFICADOR OP_OR OP_ASIGNACION expresion
    | IDENTIFICADOR OP_XOR OP_ASIGNACION expresion
    ;
